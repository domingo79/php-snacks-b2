...
//filtro array con $val 'is_active' true
...
// numero random con la lunghezza del mio nuovo array 
$numRnd = rand(0, count($active_ads));
//echo $numRnd
?>
...
<body>
    <img src='<?= $active_ads[$numRnd]['image_path'] ?>' alt="">
</body>
